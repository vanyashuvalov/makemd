...
- Customization now applies per document to both preview and PDF, and survives reloads and source export/import. See [customization verification](05-customization.md). The live preview remains a continuous reading view.
