...
What it does: records the chosen Vercel framework preset, Node version, and environment-variable posture.
Connected to: `vercel.json`, `package.json`, and the Vercel dashboard project settings.
-->
