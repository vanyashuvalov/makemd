...
export function Checkbox({
  ...
  return (
    <button
      ...
      className={cn(
        'inline-flex h-6 w-6 shrink-0 items-center justify-center rounded-[4px] border-2 transition-[background-color,border-color,color] duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2',
        isChecked || isMixed
